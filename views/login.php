...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-right">
		      ...
		      <li class="nav-item">
		        <a class="nav-link" href="signup.php"></span>Librarian Register</a>
		      </li>
		      </li>
		    </ul>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-8" id="main_content">
			<center><h3><u>Librarian Login Form</u></h3></center>
			<form action="" method="post">
				...
				<a href="signup.php"> NEED TO REGISTER AS LIBRARIAN?</a>		
			</form>
			<?php 
