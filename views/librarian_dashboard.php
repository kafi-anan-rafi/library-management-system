	...
	<div class="row" style="margin-left: 20px">
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				<div class="card-header">Assign Customers</div>
				<div class="card-body">
					<p class="card-text">No. total Users: <?php echo get_customer_count();?></p>
					<a class="btn btn-danger" href="manage_customer.php" target="_blank">View Registered Customers</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
		...
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text">No of Employees: <?php echo get_employee_count();?></p>
					<a class="btn btn-warning" href="manage_employee.php" target="_blank">View Employees</a>
				</div>
			</div>
		</div>
		<div class="col-md-3" style="margin: 0px">
