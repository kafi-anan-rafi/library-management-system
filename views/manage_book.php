					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn" name=""><a href="../models/books.php?bn=<?php echo $row['book_no'];?>">View</a></button>
                                <button class="btn" name=""><a href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
								<button class="btn"><a href="../controllers/delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
