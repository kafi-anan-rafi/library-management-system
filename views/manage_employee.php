...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<center><h4>Manage Employees</h4><br></center>
	<div class="row">
				...
				<?php
					...
					while ($row = mysqli_fetch_assoc($query_run)) {
						...
						<tr>
							...
							<td>
								<button class="btn"><a href="../models/employee.php?eid=<?php echo $row['employee_id']; ?>">View</a></button>
								<button class="btn"><a href="edit_employee.php?eid=<?php echo $row['employee_id']; ?>">Edit</a></button>
								<button class="btn"><a href="../controllers/delete_employee.php?eid=<?php echo $row['employee_id']; ?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
