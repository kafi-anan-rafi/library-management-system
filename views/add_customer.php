...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<center><h4>Add a new Customer</h4><br></center>
	<div class="row">
...
<?php
	if(isset($_POST['add_customer']))
	{
		...
		$query = "INSERT INTO customers (first_name, last_name, email, phone_number, birthdate, registration_date)
				  VALUES ('$first_name', '$last_name', '$email', '$phone_number', '$birthdate', CURDATE())";
