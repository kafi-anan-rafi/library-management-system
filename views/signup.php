...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-right">
		      <li class="nav-item">
		        <a class="nav-link" href="login.php">librarian Login</a>
		      </li>
		      <li class="nav-item">
	...
	<div class="row">
		...
		<div class="col-md-8" id="main_content">
			<center><h3><u>librarian Registration Form</u></h3></center>
			<form action="../controllers/register.php" method="post">
				...
				<a href="login.php"> DO YOU HAVE ALREADY LIBRARIAN ACCOUNT?</a>	
			</form>
		</div>
	</div>
</body>
